// PostForm.tsx - Post creation form component
// PostForm.tsx - Componente de formulario para crear posts
...
/**
 * EN: Props interface for PostForm component — callback receives a Post object
 * ES: Interfaz de props para componente PostForm — callback recibe un objeto Post
 */
interface PostFormProps {
  /** EN: Callback when a new post is created / ES: Callback cuando se crea un nuevo post */
